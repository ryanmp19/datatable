                        ...
                        <tab :id="{ label: 'front end', class: 'is-info', tag: 'mixt' }">
                            <tabs alignment="centered">
                                ...
                                <tab :id="{ label: 'vue-table', class: 'is-warning', tag: 'req' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.vueTable')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'vue-filter', class: 'is-success', tag: 'opt' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.vueFilter')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'vue-select-filter', class: 'is-success', tag: 'opt' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.vueSelectFilter')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'date-interval-filter', class: 'is-success', tag: 'opt', active: false }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.dateIntervalFilter')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'interval-filter', class: 'is-success', tag: 'opt' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.intervalFilter')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'example.js', class: 'is-info', tag: 'info' }">
                                    <div class="columns">
                                        <div class="column is-three-fifths is-offset-one-fifth">
                                            @include('examples.table.partials.exampleJs')
                                        </div>
                                    </div>
                                </tab>
                            </tabs>
                        ...
                        <tab :id="{ label: 'back end', class: 'is-info', tag: 'mixt' }">
                            <tabs alignment="centered">
                                ...
                                <tab :id="{ label: 'routes', class: 'is-warning', tag: 'req' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.routes')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'model', class: 'is-warning', tag: 'req' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.model')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'controller', class: 'is-warning', tag: 'req' }"
                                    ...
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.controller')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'exampleTable', class: 'is-warning', tag: 'req' }"
                                    ...
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.exampleTable')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'template', class: 'is-warning', tag: 'req' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.template')
                                        </div>
                                    </div>
                                </tab>
                                <tab :id="{ label: 'enum', class: 'is-success', tag: 'opt' }">
                                    <div class="columns">
                                        <div class="column is-half is-offset-one-quarter">
                                            @include('examples.table.partials.enum')
                                        </div>
                                    </div>
                                </tab>
                            </tabs>
